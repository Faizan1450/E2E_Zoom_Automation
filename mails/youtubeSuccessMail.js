export const youtubeSuccess = async ({ title, date, youtubeURL }) => {
...
<body style="margin:0;padding:0;background:#f5f7fb;">
  ...
  <div style="display:none;max-height:0;overflow:hidden;opacity:0;">
    ${safeTitle} – recording uploaded on ${safeDate}.
  </div>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                  ...
                  <td style="padding:28px 28px 12px 28px;">
                    <div style="font-family:system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif;">
                      ...
                      <p style="margin:0 0 16px 0;font-size:16px;line-height:1.6;color:#374151;">
                        We’re pleased to inform you that the Zoom recording for <b>${safeTitle}</b> has been successfully uploaded to <b>YouTube</b>.
                      </p>
                      <p style="margin:0 0 16px 0;font-size:16px;line-height:1.6;color:#374151;">
                        <b>Date:</b> ${safeDate}
                      </p>
                ...
                <tr>
                  <td align="left" style="padding:0 28px 8px 28px;">
                    <!--[if mso]>
                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="${safeUrl}" arcsize="12%" strokecolor="#2563eb" fillcolor="#2563eb" style="height:44px;v-text-anchor:middle;width:260px;">
                      <w:anchorlock/>
                      <center style="color:#ffffff;font-family:Segoe UI,Arial,sans-serif;font-size:16px;font-weight:600;">
                        ▶︎ Open YouTube Recording
                      </center>
                    </v:roundrect>
                    <![endif]-->
                    <!--[if !mso]><!-- -->
                ...
                <tr>
                  <td style="padding:10px 28px 16px 28px;">
                    <p class="muted" style="margin:0;font-family:system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif;font-size:13px;color:#6b7280;">
                      Please review the recording and proceed to upload it on the SCALive application. It can also be used for future reference or by team members who missed the live session.
                    </p>
                  </td>
                </tr>
