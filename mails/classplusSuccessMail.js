export const classplusSuccessMail = async ({ batchName, date, url }) => {
...
<body style="margin:0;padding:0;background:#f5f7fb;">
  <div style="display:none;max-height:0;overflow:hidden;opacity:0;">
    Upload successful for ${safeTopic}. Please cross-check.
  </div>
                ...
                <tr>
                  <td style="padding:28px;">
                    <div style="font-family:system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif;">
                      ...
                      <h1 style="margin:0 0 12px 0;font-size:20px;color:#16a34a;">
                        ✅ Meeting Completed Successfully
                      </h1>

                      <p style="margin:0 0 14px 0;font-size:16px;line-height:1.6;color:#374151;">
                        The meeting on <b>${safeTopic}</b> has been successfully completed and the recording has been uploaded to the <b>SCALive application</b>.
                      </p>
                      ...
                      <p style="margin:0 0 14px 0;font-size:16px;line-height:1.6;color:#374151;">
                        Please open the link above and confirm the lecture is available and accessible to students. If it's missing, download it from the Drive and re-upload it manually.
                      </p>
